        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <ul className="space-y-2">
              <li>
                <a href="#portafolio" className="text-white/80 hover:text-secondary transition-colors">
                  Portafolio
                </a>
              </li>
              <li>
                <a href="#servicios" className="text-white/80 hover:text-secondary transition-colors">
                  Servicios
                </a>
              </li>
              <li>
                <a href="#conocenos" className="text-white/80 hover:text-secondary transition-colors">
                  Conócenos
                </a>
              </li>
              <li>
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:contacto@Husheniid.com" className="text-white/80 hover:text-secondary transition-colors">
